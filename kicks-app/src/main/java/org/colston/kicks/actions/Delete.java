...
public class Delete extends AbstractAction {
    public static final String ACTION_COMMAND = "action.delete";

    private static final String MESSAGE_RESOURCE_PREFIX = "delete";
    private static final String SMALL_ICON_NAME = "Delete24.png";
    private static final String LARGE_ICON_NAME = "Delete24.png";
