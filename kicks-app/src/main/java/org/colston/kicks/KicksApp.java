...
public class KicksApp extends GuiApp {
    ...
    protected void configureOther(String[] args) throws Exception {
        ...
        for (String resourceName : PageRenderer.getFontResourceNames()) {
            try (BufferedInputStream bis = new BufferedInputStream(openFontResourceInputStream(resourceName))) {
    ...
    public static InputStream openFontResourceInputStream(String fontResourceName) {
        return PageRenderer.class.getResourceAsStream(fontResourceName);
    }
