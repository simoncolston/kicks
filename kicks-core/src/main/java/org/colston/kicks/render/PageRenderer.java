...
public class PageRenderer implements Printable {
    ...
    private static final Font titleFont = new Font(V_FONT_NAME, Font.PLAIN, 26);
    private static final Font ftitleFont = new Font(V_FONT_NAME, Font.PLAIN, 12);
    private static final Font rtitleFont = new Font(R_FONT_NAME, Font.PLAIN, 14);
    private static final Font font = new Font(FONT_NAME, Font.PLAIN, 18);
    ...
    private LocatableRange selection;
    ...
    public PageRenderer cursor(PageCursor cursor) {
        this.cursor = cursor;
        return this;
    }
