...
#### Script Import `kicksabc`

- [x]   4   `kicksabc` script import
- [x]   4   Implement `E:` (english/romaji) command for `kicksabc` - english/romaji title
- [ ]   5   Implement `M:` (meter/rhythm) command for `kicksabc` - `simple` or `compound` rhythm
- [ ]   2   Implement `S:` (source/transcribed from) command - Recording the music was transcribed from
- [ ]   2   Implement `C:` (composer)
- [ ]   2   Start and stop voice markers. 
            `(` = start - aligned with next syllable, 
            `)` = stop - aligned one cell after previous syllable (but support absolute positioning)
...
- [ ] **1** Create executable
- [ ] **1** Versioning of jar file artefacts
