...
public class KicksMain
{
	...
	private static Settings settings = new PreferencesSettings();
	private static DocumentStore documentStore;
	private static MainActionProvider mainActionProvider = new MainActionProvider();
	...
	private static void createUI()
	{
		...
		try
		{
			...
			{
				images.add(ImageIO.read(KicksMain.class.getResource(iname)));
			}
	...
	private static JToolBar createToolBar()
	{
		...
		boolean added = false;
		added = addButtons(toolBar, "menu.file", added);
		added = addButtons(toolBar, "menu.edit", added);
		added = addButtons(toolBar, "menu.document", added);
		return toolBar;
	}
