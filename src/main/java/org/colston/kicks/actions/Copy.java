...
public class Copy extends AbstractAction {
    public static final String ACTION_COMMAND = "action.copy";

    private static final String MESSAGE_RESOURCE_PREFIX = "copy";
    private static final String SMALL_ICON_NAME = "Copy24.png";
    private static final String LARGE_ICON_NAME = "Copy24.png";
