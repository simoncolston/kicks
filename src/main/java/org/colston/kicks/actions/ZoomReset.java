...
public class ZoomReset extends AbstractAction {
    public static final String ACTION_COMMAND = "action.zoom.reset";

    private static final String MESSAGE_RESOURCE_PREFIX = "zoom.reset";
    private static final String SMALL_ICON_NAME = "ZoomReset24.png";
    private static final String LARGE_ICON_NAME = "ZoomReset24.png";
