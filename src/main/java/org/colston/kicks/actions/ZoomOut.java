...
public class ZoomOut extends AbstractAction {
    public static final String ACTION_COMMAND = "action.zoom.out";

    private static final String MESSAGE_RESOURCE_PREFIX = "zoom.out";
    private static final String SMALL_ICON_NAME = "ZoomOut24.png";
    private static final String LARGE_ICON_NAME = "ZoomOut24.png";
