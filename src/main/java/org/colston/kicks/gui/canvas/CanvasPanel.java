...
class CanvasPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        pageRenderer = new PageRenderer(model.getDocument(),
                KicksApp.settings(),
                cursorModel.getSelection(),
                SELECTION_COLOUR,
                pageIndex,
                new PageCursor(cursorModel.getCursorIndex(), cursorModel.getCursorOffset(), cursorModel.isCursorOnNote()));
